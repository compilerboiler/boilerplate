---
title: tkinter example PopupMenuDemo (snippet)
date: 2019-02-08
tags: ["python"]
---
Python tkinter (gui) example 'PopupMenuDemo'


## PopupMenuDemo

Python tkinter example: PopupMenuDemo
...
class PopupMenuDemo:
    def __init__(self):
        ...
        self.canvas.bind("<Button-3>", self.popup) #right mouse button
