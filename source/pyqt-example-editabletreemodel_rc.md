---
title: pyqt example editabletreemodel rc (snippet)
date: 2020-02-10
tags: ["python"]
---
Python pyqt (gui) example 'editabletreemodel rc'

Functions in program: 
* `def qCleanupResources():`
* `def qInitResources():`

## editabletreemodel rc

Python pyqt example: editabletreemodel rc
