---
title: tkinter example WidgetsDemo (snippet)
date: 2020-02-09
tags: ["python"]
---
Python tkinter (gui) example 'WidgetsDemo'


## WidgetsDemo

Python tkinter example: WidgetsDemo
...
class WidgetsDemo:
    def __init__(self):
        ...
        frame1.pack()      
        self.v1 = IntVar() #IntVar is a class defined in tkinter module; v1 is the object/instance
